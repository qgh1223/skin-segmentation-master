...
def deeplabv3_plus(IMG_ROW,IMG_COL,out_stride=16,COLORNUM=21):

    img_input=Input(shape=(IMG_ROW,IMG_COL,3))
    ...
    x=aspp(x,(IMG_ROW,IMG_COL,3),out_stride)
    ...
    x=Conv2D(COLORNUM,(1,1),padding="same")(x)
